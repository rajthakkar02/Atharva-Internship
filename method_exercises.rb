...
array_value = common_sports(["cricket","football","basketball"],["Volleyball","lawn Tennis","Table Tennis","Swimming"])
print array_value
...
games_value = alphabetical_list(["cricket","basketball","volleyball","cricket","lawn Tennis","volleyball"])
print "\n#{games_value}"
